...
parser.add_argument('--ckpt',
                    type=str,
                    default='result/outputs/funit_human2anime/checkpoints/gen_00075000.pt')
parser.add_argument('--class_image_folder',
                    type=str,
                    default='test/class_images/lijing')
parser.add_argument('--input',
                    type=str,
                    default='test/content_images/input_content.jpg')
parser.add_argument('--output',
                    type=str,
                    default='test/output_images/output.jpg')
...
for i, f in enumerate(images):
    ...
    with torch.no_grad():
        ...
        if i == 0:
            ...
            new_class_code += class_code
final_class_code = new_class_code / len(images) # get the average class code
